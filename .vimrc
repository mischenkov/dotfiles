...
" Vundle setup
    ...
    " Interface
        ...
        "Taglist: creates letf sidebar with functions, classes etc.
        ...
        "Zencoding: plugin for HTML and CSS hi-speed coding
...
" Шорткаты
    ...
    " ,r
        ...
        "Временно закомментировал, так как в плагине PythonMode это сочетание
        "клавиш используется для запуска скрипта
